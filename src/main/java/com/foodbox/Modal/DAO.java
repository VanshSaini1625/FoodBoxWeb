...
public class DAO {
	...
	public DAO() throws ClassNotFoundException, SQLException {
		...
		c=DriverManager.getConnection("jdbc:mysql://localhost:3306/foodbox","root","Ravi@2003");
	}
	...
	// Save review
	public boolean addReview(int itemId, int rating, String comment) {
	    try {
	        PreparedStatement ps = c.prepareStatement("INSERT INTO item_reviews(item_id, rating, comment) VALUES (?, ?, ?)");
	        ps.setInt(1, itemId);
	        ps.setInt(2, rating);
	...
	public ArrayList<HashMap<String, String>> getReviewsByItemId(int itemId) {
	    ArrayList<HashMap<String, String>> list = new ArrayList<>();
	    try {
	        PreparedStatement ps = c.prepareStatement("SELECT rating, comment, created_at FROM item_reviews WHERE item_id=? ORDER BY id DESC");
	        ps.setInt(1, itemId);
