...
<body>
	...
	%>
		<nav class="navbar navbar-expand-sm container my-3">
	        ...
	        <div class="collapse navbar-collapse" id="my-navbar">
	            ...
	            <a id="call" href="tel:9999XXXXXX"><i class="fa-solid fa-mobile-screen-button"></i> 9811XXXXXX</a>
	        </div>
	    </nav>
	<%	
	}else{
    ...
    <section>
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="resources/banner4.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <section id="gallery" class="container my-5">
        ...
        <a href="resources/banner3.jpg" data-toggle="lightbox" data-gallery="my-gallery"><img src="resources/banner3.jpg" alt=""></a>
        <a href="resources/banner4.jpg" data-toggle="lightbox" data-gallery="my-gallery"><img src="resources/banner4.jpg" alt=""></a>
        <a href="resources/banner5.jpg" data-toggle="lightbox" data-gallery="my-gallery"><img src="resources/banner5.jpg" alt=""></a>
    </section>
    <section class="container-fluid">
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14028.751917211743!2d77.49045005236488!3d28.473885012024255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea1037e5970d%3A0x9f742e8db599a627!2sIIMT%20College%20of%20Management!5e0!3m2!1sen!2sin!4v1713890174701!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </section>
    <footer class="bg-dark p-5 text-center">
        ...
        <p>
          <a href="https://www.facebook.com/iimtmeerutgreaternoida/"><i class="fa-brands fa-facebook"></i></a>
          <a href="https://www.instagram.com/iimtindia/?hl=en"><i class="fa-brands fa-instagram"></i></a>
          <a href="https://www.youtube.com/c/IIMTGroupofColleges"><i class="fa-brands fa-youtube"></i></a>
        </p>
    </footer>
